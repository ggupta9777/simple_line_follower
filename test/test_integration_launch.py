...
def generate_test_description():
    ...
    # Line follower node
    line_follower_node = launch_ros.actions.Node(
    ...
    naive_line_follower_node = launch_ros.actions.Node(
        package="simple_line_follower",
...
# This test will check that none of the launched 
# processes and nodes crashed
